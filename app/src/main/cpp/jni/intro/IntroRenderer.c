...
JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_onDrawFrame(JNIEnv *env, jclass class) {
    time_local += 0.016f;
    ...
    if (current_page == 0) {
        if (direct == 0) {
            ...
            change_segmented_square(&spiral, r1, D2R(rr + seg),
                                    D2R(speedometer_scroll_offset + calculated_speedometer_sin +
                                        t(-seg + ang, 0, 0, duration_const, EaseOut)));
            ...
            fast_arrow.params.alpha = fast_arrow_shadow.params.alpha = t(1, 0, 0, duration_const,
                                                                         Linear);
            fast_arrow.params.rotation = fast_arrow_shadow.params.rotation =
                    t(rr, rr - 180 - 160, 0, duration_const, EaseOut) + speedometer_scroll_offset +
                    calculated_speedometer_sin;
        ...
        if (direct == 1) {
            ...
            change_segmented_square(&spiral, r1, D2R(rr + seg),
                                    D2R(-seg + value + speedometer_scroll_offset));
            ...
            fast_arrow.params.alpha = fast_arrow_shadow.params.alpha = t(0, 1, 0, duration_const,
                                                                         Linear);
            fast_arrow.params.rotation = fast_arrow_shadow.params.rotation =
                    -330 + value + ta + speedometer_scroll_offset;
            draw_textured_shape(&fast_arrow_shadow, main_matrix, NORMAL_ONE);
            draw_textured_shape(&fast_arrow, main_matrix, NORMAL_ONE);
            ...
            change_segmented_square(&spiral, r1, D2R(rr + seg),
                                    D2R(speedometer_scroll_offset + value +
                                        calculated_speedometer_sin +
                                        t(360, 360 - dangle - seg, 0, duration_const,
                                          EaseInEaseOut)));
            ...
            fast_arrow.params.rotation = fast_arrow_shadow.params.rotation =
                    speedometer_scroll_offset + value + calculated_speedometer_sin +
                    t(rr + 360 + 6, rr + 360 - 180 - dangle, 0, duration_const, EaseInEaseOut);
        ...
        if (direct == 1) {
            ...
            change_segmented_square(&spiral, r1, D2R(rr + seg + speedometer_scroll_offset),
                                    D2R(t(-seg + ang, 360, 0, duration_const, EaseInEaseOut)));
            ...
            fast_arrow.params.rotation = fast_arrow_shadow.params.rotation =
                    speedometer_scroll_offset +
                    t(rr, rr + 360 + 6, 0, duration_const, EaseInEaseOut);
            draw_textured_shape(&fast_arrow_shadow, main_matrix, NORMAL);
            draw_textured_shape(&fast_arrow, main_matrix, NORMAL);
    ...
    if (current_page == 0) {
        ...
        if (direct == 1) {
            ...
            ribbonLayer.rotation =
                    scroll_offset * 5 + t(180, 360, 0, duration_const, EaseInEaseOut);
            ...
            glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
            ribbon1.params.alpha = ribbon2.params.alpha = ribbon3.params.alpha = ribbon4.params.alpha = t(
                    0, 1, 0, dur, EaseInEaseOut);

            int32_t ribbon_k = time > duration_const ? 1 : 0;

            change_ribbon(&ribbon1, ribbonLength - 8.0f * ribbon_k -
                                    free_scroll_offset / 5.0f * (30 - 8 * ribbon_k));
            ribbon1.params.position.x =
                    scroll_offset * 30 * 0 + t(-dribbon, 0, 0, duration_const, EaseInEaseOut);
            draw_shape(&ribbon1, ribbons_layer);

            change_ribbon(&ribbon2, ribbonLength - 10.0f * ribbon_k -
                                    free_scroll_offset / 5.0f * (22 - 10 * ribbon_k));
            ribbon2.params.position.y =
                    scroll_offset * 15 + t(-9 - dribbon, -9, 0, duration_const, EaseInEaseOut);
            ...
            ribbonLayer.rotation = free_scroll_offset +
                                   t_reversed(360, 360 + (45 + 30), 0, duration_const, EaseOut);
            ...
            float k = 0.9f;
            ribbon2.params.alpha = ribbon4.params.alpha = t_reversed(1, 0, duration_const * 0.5f,
                                                                     duration_const * 0.1f, Linear);

            int32_t ribbon_k = 0;
            change_ribbon(&ribbon1,
                          t_reversed(ribbonLength - 8.0f * ribbon_k, 0, 0, duration_const * 0.9f,
                                     Linear) - free_scroll_offset / 5.0f * (30 - 8 * ribbon_k));
            ribbon1.params.position.x = 0;
            draw_shape(&ribbon1, ribbons_layer);

            change_ribbon(&ribbon2,
                          t_reversed(ribbonLength - 10.0f * ribbon_k, 0, 0, duration_const * k,
                                     Linear) - free_scroll_offset / 5.0f * (22 - 10 * ribbon_k));
            ...
            change_ribbon(&ribbon4,
                          t_reversed(ribbonLength, 0, duration_const * 0.6f * 0, duration_const * k,
                                     Linear));
            draw_shape(&ribbon4, ribbons_layer);
            ...
            change_infinity(&infinity,
                            t_reversed(0, 0.99, 0, duration_const * infinityDurK, EaseOut));
        ...
        if (direct == 1) {
            ...
            glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
            ribbonLayer.rotation =
                    free_scroll_offset + t(360, 360 + (45 + 30), 0, duration_const * 0.8f, EaseOut);
            ...
            float k = 0.5f;
            ribbon2.params.alpha = ribbon4.params.alpha = t(1, 0, duration_const * k * 0.5f,
                                                            duration_const * k * 0.1f, Linear);

            int32_t ribbon_k = time > duration_const ? 1 : 0;

            change_ribbon(&ribbon1, t(ribbonLength - 8.0f * ribbon_k -
                                      free_scroll_offset / 5.0f * (30 - 8 * ribbon_k), 0, 0,
                                      duration_const * 0.9f, Linear));
            draw_shape(&ribbon1, ribbons_layer);

            change_ribbon(&ribbon2, t(ribbonLength - 10.0f * ribbon_k -
                                      free_scroll_offset / 5.0f * (22 - 10 * ribbon_k), 0, 0,
                                      duration_const * k, Linear));
            draw_shape(&ribbon2, ribbons_layer);
            ...
            change_rounded_rectangle_stroked(&private_stroke, CSizeMake(scale, scale),
                                             scale / 2.0f);
        ...
        if (direct == 1) {
            ...
            private_keyhole_body.params.alpha = t(.0, 1.0f, duration_const * k, duration_const,
                                                  EaseOut);
            ...
            private_keyhole_body.params.rotation = private_scroll_offset;
            private_keyhole_body.params.scale = xyzMake(scale, scale, 1);
            private_keyhole_body.params.alpha = t(.0, 1.0f, 0, duration_const * private_back_k,
                                                  EaseOut);

            if (time < duration_const * .4) {
                cloud_cover.params.position.y = t_reversed(118 / 2 + 50, 118 / 2,
                                                           duration_const * 0.8f * private_back_k,
                                                           duration_const * private_back_k,
                                                           EaseOut);
                draw_shape(&cloud_cover, main_matrix);
            }

            draw_safe(0, t(0, 1, duration_const * private_back_k * 0.0f,
                           duration_const * private_back_k, Linear),
                      t(0, 1, 0, duration_const, Linear));
        }
    } else if (current_page == 5) {
        ...
        private_keyhole_body.params.rotation = private_scroll_offset;
        private_keyhole_body.params.scale = xyzMake(scale, scale, 1);
        private_keyhole_body.params.alpha = t(1.0, 0.0, 0, duration_const * private_fade_k * 0.5f,
                                              EaseOut);
        privateLayer.rotation = private_scroll_offset;
        mat4x4_layer(private_matrix, privateLayer,
                     t(1, 0.9f, 0, duration_const * private_fade_k, EaseOut), 0);
...
JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setScrollOffset(JNIEnv *env, jclass class,
                                                                          float a_offset) {
    scroll_offset = a_offset;
}

JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setPage(JNIEnv *env, jclass class,
                                                                  int32_t page) {
...
JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setDate(JNIEnv *env, jclass class,
                                                                  float a) {
    date = a;
}

JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setIcTextures(JNIEnv *env, jclass class,
                                                                        jint a_ic_bubble_dot,
                                                                        jint a_ic_bubble,
                                                                        jint a_ic_cam_lens,
                                                                        jint a_ic_cam,
                                                                        jint a_ic_pencil,
...
JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setTelegramTextures(JNIEnv *env,
                                                                              jclass class,
                                                                              jint a_telegram_sphere,
                                                                              jint a_telegram_plane) {
    telegram_sphere_texture = a_telegram_sphere;
    telegram_plane_texture = a_telegram_plane;
}

JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setFastTextures(JNIEnv *env, jclass class,
                                                                          jint a_fast_body,
                                                                          jint a_fast_spiral,
                                                                          jint a_fast_arrow,
                                                                          jint a_fast_arrow_shadow) {
...
JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setFreeTextures(JNIEnv *env, jclass class,
                                                                          jint a_knot_up,
                                                                          jint a_knot_down) {
...
JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setPowerfulTextures(JNIEnv *env,
                                                                              jclass class,
                                                                              jint a_powerful_mask,
                                                                              jint a_powerful_star,
                                                                              jint a_powerful_infinity,
                                                                              jint a_powerful_infinity_white) {
...
JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_setPrivateTextures(JNIEnv *env,
                                                                             jclass class,
                                                                             jint a_private_door,
                                                                             jint a_private_screw) {
    private_door_texture = a_private_door;
    private_screw_texture = a_private_screw;
}

JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_onSurfaceCreated(JNIEnv *env,
                                                                           jclass class) {
    ...
    fast_arrow_shadow = create_textured_rectangle(CSizeMake(164 / 2, 44 / 2),
                                                  fast_arrow_shadow_texture);
    ...
    powerful_infinity = create_textured_rectangle(CSizeMake(366 / 3, 180 / 3),
                                                  powerful_infinity_texture);
    powerful_infinity_white = create_textured_rectangle(CSizeMake(366 / 3, 180 / 3),
                                                        powerful_infinity_white_texture);
    ...
    private_keyhole_body = create_textured_rectangle(CSizeMake(216 / 3, 216 / 3),
                                                     private_keyhole_body_texture);
    private_screw = create_textured_rectangle(CSizeMake(30 / 3, 30 / 3), private_screw_texture);
    private_stroke = create_rounded_rectangle_stroked(CSizeMake(244 / 2, 244 / 2), 21, 9, 16,
                                                      white_color);
...
JNIEXPORT void
Java_uz_uniconsoft_messanger_presentation_component_Intro_onSurfaceChanged(JNIEnv *env,
                                                                           jclass class,
                                                                           int32_t a_width_px,
                                                                           int32_t a_height_px,
